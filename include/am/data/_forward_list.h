...
static AM_INLINE void am_forward_list(struct am_forward_list *l);
static AM_INLINE void am_forward_list_node(struct am_forward_list_node *n);
...
static AM_INLINE void am_forward_list_insert_after(struct am_forward_list_node *pos, struct am_forward_list_node *value);
/* Insert at the front */
static AM_INLINE void am_forward_list_push_front(struct am_forward_list *l, struct am_forward_list_node *value);
